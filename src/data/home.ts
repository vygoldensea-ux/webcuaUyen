...
export const heroSlides: HeroSlide[] = [
  {
    ...
    subtitle: "Chòi của Uyn tư vấn theo từng gương mặt, nền môi, dáng mày và tình trạng da thật của mỗi khách.",
    primaryCta: "Đặt lịch tư vấn",
    secondaryCta: "Xem dịch vụ",
    image: "/images/hero-1.png",
    alt: "Khách hàng tại Chòi của Uyn – Mini Spa & Aesthetics Vũng Tàu",
    accent: "Tư vấn theo gương mặt thật",
  },
  {
    id: "slide-2",
    title: "Phun môi & chân mày — kết quả thật, dáng mềm",
    subtitle: "Kiểm tra nền môi, dáng mày và tư vấn màu hoặc dáng phù hợp trước khi làm.",
    primaryCta: "Xem ưu đãi",
    image: "/images/hero-2.png",
    alt: "Kết quả phun môi và phun chân mày tại Chòi của Uyn Vũng Tàu",
    accent: "Ưu đãi cho lịch hẹn sớm",
  },
  {
    id: "slide-3",
    title: "Meso căng bóng — phục hồi da thiếu ẩm",
    subtitle: "Cấp ẩm sâu, phục hồi độ mịn và độ căng nhẹ cho da xỉn màu, thiếu sức sống.",
    primaryCta: "Tìm hiểu Meso",
    image: "/images/hero-3.png",
    alt: "Dịch vụ Meso căng bóng cấp ẩm tại Chòi của Uyn Vũng Tàu",
    accent: "Da thiếu ẩm, xỉn màu, kém mịn",
  },
  {
    id: "slide-4",
    title: "Filler & Botox — hài hòa, không quá tay",
    subtitle: "Ưu tiên gương mặt hài hòa, tự nhiên. Tư vấn liều và vị trí phù hợp trước khi làm.",
    primaryCta: "Tư vấn trước khi làm",
    image: "/images/hero-4.png",
    alt: "Dịch vụ filler và botox tại Chòi của Uyn Vũng Tàu",
    accent: "Ưu tiên kết quả hài hòa",
  },
  {
    id: "slide-5",
    title: "Chăm sóc da mụn — sạch, phục hồi từng buổi",
    subtitle: "Lấy nhân mụn, làm sạch và phục hồi theo tình trạng thực tế. Theo dõi qua từng ca.",
    primaryCta: "Đặt lịch chăm sóc da",
    image: "/images/hero-5.png",
    alt: "Dịch vụ chăm sóc da mụn tại Chòi của Uyn Vũng Tàu",
    accent: "Theo dõi sau mỗi buổi",
  },
  {
    id: "slide-6",
    title: "Mini Spa tại Vũng Tàu — nhỏ nhưng làm kỹ",
    subtitle: "Một chỗ nhỏ, không chạy theo số lượng. Mỗi ca là một buổi tư vấn riêng.",
    primaryCta: "Khám phá Chòi của Uyn",
    secondaryCta: "Xem dịch vụ",
    image: "/images/hero-6.png",
    alt: "Không gian Chòi của Uyn Mini Spa Vũng Tàu",
    accent: "Vũng Tàu · Tư vấn rõ · Làm vừa đủ",
  },
];
