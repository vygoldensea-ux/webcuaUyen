...
export function HeroPromoSlider() {
  ...
  return (
    <section className="section-frame px-4 pt-6 pb-20 lg:px-6 lg:pt-10 lg:pb-24">
                ...
                >
                  <div className="grid gap-6 px-5 py-6 sm:gap-8 sm:px-8 sm:py-8 md:px-10 lg:min-h-[640px] lg:grid-cols-[1.05fr_0.95fr] lg:items-center lg:gap-10 lg:px-14 lg:py-14">
                    <div className="relative z-10 flex flex-col justify-center">
                      <span className="eyebrow mb-4 text-[11px] text-[color:var(--earth)]">
                    ...
                    <div className="relative min-h-[260px] sm:min-h-[360px] lg:min-h-[540px]">
                      ...
                      <motion.div
                        animate={{
                          scale: selectedIndex === index ? 1.02 : 0.98,
      ...
      <div className="-mt-4 grid gap-3 px-1 sm:-mt-10 sm:gap-4 sm:px-5 sm:grid-cols-3">
        {trustHighlights.map((item) => (
          <div
            key={item}
            className="soft-card rounded-[22px] px-4 py-4 text-sm font-medium text-[color:var(--foreground)] sm:rounded-[24px] sm:px-5 sm:py-5"
          >
            {item}
          </div>
        ))}
      ...
      <div className="mt-6 flex flex-col gap-2 px-1 text-sm text-[color:var(--muted)] sm:mt-8 sm:flex-row sm:items-center sm:justify-between sm:px-2">
